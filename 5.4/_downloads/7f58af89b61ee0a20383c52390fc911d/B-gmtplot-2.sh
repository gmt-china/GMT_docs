...
gmt psxy -R -J -O -K -Sv0.03i+b+e+jc -W0.5p -Gblack -Y-0.5i -N << EOF >> GMT_-B_geo_2.ps
-1.875 0 0 0.33333
-0.45833 0 0 0.11111
0.541666 0 0 0.11111
EOF
gmt pstext -R -J -O -K -N -F+f+j << EOF >> GMT_-B_geo_2.ps
-2.1 0.025 10p RM P:
-1.875 0.05 6p CB annotation
-0.45833 0.05 6p CB frame
0.541666 0.05 6p CB grid
EOF
gmt psxy -R -J -O -K -Sv0.03i+b+e+jc -W0.5p -Gblack -Y-0.225i -N << EOF >> GMT_-B_geo_2.ps
-1.5 0 0 1.33333
-0.25 0 0 0.66666
0.625 0 0 0.33333
EOF
gmt pstext -R -J -O -N -F+f+j << EOF >> GMT_-B_geo_2.ps
-2.1 0.025 10p RM S:
