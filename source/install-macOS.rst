...
2. 双击 dmg 包以解压，将解压得到的 ``GMT-5.4.0.app`` 拖动到 Applications 目录即可。

3. GMT 默认会安装到 ``/Applications/GMT-5.4.0.app/`` 目录下，将如下语句::

       export PATH=${PATH}:/Applications/GMT-5.4.0.app/Contents/Resources/bin
