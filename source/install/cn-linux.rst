...
GMT 原生并不支持中文。为了让 GMT 支持中文，需要首先修改 ghostscript 的配置文件
使得其支持中文，再修改 GMT 的配置文件。
...
CentOS 7下，ghostscript的中文配置文件的路径为
...
下载PS测试文件 :download:`GMT_Chinese_Linux.ps </install/GMT_Chinese_Linux.ps>`\ ，
