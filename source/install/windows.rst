...
1.  下载 GMT 6.0.0rc4 安装包
    ...
    - `gmt-6.0.0rc4-win64.exe (64位) <http://mirrors.ustc.edu.cn/gmt/bin/gmt-6.0.0rc4-win64.exe>`__
    - `gmt-6.0.0rc4-win32.exe (32位) <http://mirrors.ustc.edu.cn/gmt/bin/gmt-6.0.0rc4-win32.exe>`__
