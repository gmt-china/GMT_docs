...
gmt begin 3D_earth_relief_1
    ...
    gmt grdview @earth_relief_06m_p -R101/108/35/42/-1000/20000 -JM10c -JZ10c -N-1000+ggray -Qs -Cgeo -I+d -Ba -BwsENZ -p60/25    
    ...
    gmt grdimage @earth_day_06m_p -p60/25/20000 -Ba -BWSen
gmt end show
