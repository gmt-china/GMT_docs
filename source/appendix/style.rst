...
GMT中提供了 ``gmtset`` 模块可以用于修改缺省参数，比如标题的字体、大小等等。
...
在脚本的最后执行 ``gmt end`` 时，\ ``gmtset`` 生成的配置文件 ``gmt.conf`` 会被
自动删除。
...
#. 定义Verbose变量
   ...
   .. code-block:: bash
      ...
      gmt begin map pdf
      gmt coast -JM20c -R0/360/-60/60 -Bx60 -By30 -W1p -A1000 $V
      gmt plot ... $V
      gmt end
...
#. 修改缺省参数
   ...
   .. code-block:: bash
      ...
      gmt coast -JM20c -R0/360/-60/60 -Bx60 -By30 -W1p -A1000
      gmt end
