...
.. gmt-plot::
   ...
   gmt basemap -R10/70/-3/8 -JX8c/5c -Bx10 -By3 -B+t"Linear X-Y Plot" -png GMT_tutor1_1
...
- ``-png GMT_tutor1_1`` 表示生成名为 GMT_tutor1_1 的PNG格式的图片
...
.. gmt-plot::
    ...
    gmt basemap -R1/10000/1e20/1e25 -JX15cl/10cl -Bxa2+l"Wavelength (m)" \
        -Bya1pf3+l"Power (W)" -BWS -png GMT_tutor1_2
...
.. gmt-plot::
    ...
    gmt coast -R-90/-70/0/20 -JM6i -Ba -Gchocolate -png GMT_tutor1_3
