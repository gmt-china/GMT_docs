...
模块会读取数据中的第一列，对其进行统计，并绘制直方图或累积直方图。

语法
----

**gmt histogram** [ *table* ] |-J|\ *parameters*
...
**-Ll**\|\ **h**\|\ **b**
    ...
    - ``-Ih`` 大于最后一个直方的统计范围的数据算入最后一个直方
    - ``-Ib`` 小于第一个直方的统计范围的数据算入第一个直方，并且大于最后一个直方的统计范围的数据算入最后一个直方
