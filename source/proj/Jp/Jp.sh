...
gmt basemap -JP4c+a -R0/90/0/1 -Bxa45f -Bya0.2 -BWNe+t"-JP4c+a -R0/90/0/1" -X5.5c
gmt set FORMAT_GEO_MAP +D FONT_TITLE 10p,1,red
gmt basemap -JP4c+a+t45 -R0/90/0/1 -Bxa45f -Bya0.2 -BWNse+t"-JP4c+a+t45 -R0/90/0/1" -X-11c -Y-5.5c
gmt basemap -JP4c+a+t45 -R0/90/3480/6371 -Bxa45f -Bya -BWNse+t"-JP4c+a+t45 -R0/90/3480/6371" -X5.5c -Y1c
