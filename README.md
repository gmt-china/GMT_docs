...
[![Documentation version](https://img.shields.io/badge/版本-v6.7-blue.svg)](https://docs.gmt-china.org/latest/)
...
| Emoji | 类型 | 说明 | Emoji | 类型 | 说明 |
|---|---|---|---|---|---|
| 🐛 | bug | 报告 Bug | 🔣 | data | 整理数据 |
| 📖 | doc | 撰写文档 | 🎨 | design | 网页设计 |
