...
.. glossary::
    ...
    **FORMAT_DATE_OUT**
        ...
        参考 :term:`FORMAT_DATE_IN <FORMAT_DATE_IN>` 的相关说明。除此之外：
    ...
    **FORMAT_DATE_MAP**
        ...
        参考 :term:`FORMAT_DATE_IN <FORMAT_DATE_IN>` 和 :term:`FORMAT_DATE_OUT <FORMAT_DATE_OUT>`
        中的相关说明。除此之外，
...
.. glossary::
    ...
    **FORMAT_GEO_OUT**
        ...
        - ``[±]D``\ ：表示将地理数据以浮点数的形式输出，浮点数的格式由
          :term:`FORMAT_FLOAT_OUT <FORMAT_FLOAT_OUT>` 决定
    ...
    **FORMAT_GEO_MAP**
        ...
        格式的具体定义参考 :term:`FORMAT_GEO_OUT <FORMAT_GEO_OUT>`\ ，
...
.. glossary::
    ...
    **FORMAT_FLOAT_MAP**
        ...
        见 :term:`FORMAT_FLOAT_OUT <FORMAT_FLOAT_OUT>` 中的相关说明。
...
.. glossary::
    ...
    **FORMAT_TIME_SECONDARY_MAP**
        ...
        见 :term:`FORMAT_TIME_PRIMARY_MAP <FORMAT_TIME_PRIMARY_MAP>` 中的相关说明。
